...
import { Mail, Phone, MapPin, Send, CheckCircle, Twitter, Linkedin, Github, Facebook, Instagram } from "lucide-react"
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12">
            {/* Contact Form */}
            <Reveal>
              <div className="bg-card/60 p-8 rounded-xl border border-border">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="mailto:support@paybridge.com" className="text-primary hover:underline">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-1">Mon-Fri from 9am to 5pm</p>
                    </div>
                  </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            <Reveal>
              ...
              <p className="text-muted-foreground">Visit our headquarters in the heart of San Francisco</p>
            </Reveal>
          </div>
            ...
            <div className="bg-card rounded-xl overflow-hidden h-96 relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-primary/50 to-secondary/50">
                <div className="text-center p-6 bg-background/80 rounded-lg">
                  ...
                  <p className="text-muted-foreground">123 Payment Street, San Francisco, CA</p>
                </div>
              </div>
            </div>
          </Reveal>
